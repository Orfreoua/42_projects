...
int	main(int ac, char **av)
{
	...
	data.arg.we = strdup("./textures/chocolatewaferstraw.xpm");
	data.arg.ea  = strdup("./textures/concrete2_seamless_diffuse_1k.xpm");
	data.arg.no = strdup("./textures/images.xpm");
	...
	////
	data.win = mlx_new_window(data.mlx, R_WIDTH, R_HEIGHT, "cub3D");
	data.buff01.img = mlx_new_image(data.mlx, R_WIDTH, R_HEIGHT);
